...
@protocol SLUserAuthenticationDelegate;
//@class DBContentObject;


////////////////////////////////////////////////////////////////////////////////////////////////

@interface SLUser : NSManagedObject <RKObjectLoaderDelegate> {
	// Transient. Used for login & sign-up
	NSString* _password;
	NSString* _passwordConfirmation;
	NSObject<SLUserAuthenticationDelegate>* _delegate;
}

/**
 * The delegate for the User. Will be informed of session life-cycle events
 */
@property (nonatomic, assign) NSObject<SLUserAuthenticationDelegate>* delegate;
 ...
 * Notifications
 */
extern NSString* const SLUserDidLoginNotification; // Posted when the User logs in
extern NSString* const SLUserDidLogoutNotification; // Posted when the User logs out
